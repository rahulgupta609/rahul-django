...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'nw6ja)8f83bphx6tim^br2x4fnj&3#j4s%3ib&w20508(ud+=s')
...
# See .ebextensions/DjangoProject.config
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'DjangoProject.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
